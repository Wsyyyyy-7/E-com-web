...
# Explicitly include key routers to ensure APIs are available even if dynamic discovery skips them
try:
    from routers import (
        auth,
        campaigns,
    ...
    logging.getLogger(__name__).warning("Failed to explicitly include routers: %s", exc)
